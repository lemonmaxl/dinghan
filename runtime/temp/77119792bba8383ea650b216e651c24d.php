<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"C:\PHP\wamp64\www\fastadmin\public/../application/admin\view\general\config\index.html";i:1533210197;s:70:"C:\PHP\wamp64\www\fastadmin\application\admin\view\layout\default.html";i:1529292885;s:67:"C:\PHP\wamp64\www\fastadmin\application\admin\view\common\meta.html";i:1529292885;s:69:"C:\PHP\wamp64\www\fastadmin\application\admin\view\common\script.html";i:1529292885;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="widget-body no-padding">
                    <form id="<?php echo $vo['name']; ?>-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.config/edit'); ?>">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th width="15%"><?php echo __('Title'); ?></th> <!-- 变量标题 -->
                                    <th width="70%"><?php echo __('Value'); ?></th> <!-- 变量值 -->
                                    <th width="15%"><?php echo __('Name'); ?></th> <!-- 变量名 -->
                                </tr>
                            </thead>
                            <tbody>
